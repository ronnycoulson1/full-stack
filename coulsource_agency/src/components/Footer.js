            ...
            <div className="max-w-7xl mx-auto px-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 ">
                ...
                <div>
                    ...
                    <ul className="mt-2 space-y-1">
                        ...
                        <li>
                            <Link href="/"  className="text-gray-400 hover:text-brand-ornage">
                                Home
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link href="/about"  className="text-gray-400 hover:text-brand-ornage">
                                About
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link href="/services"  className="text-gray-400 hover:text-brand-ornage">
                                Services
                            </Link>
                        </li>
                        ...
                        <li>
                            <Link href="/contact"  className="text-gray-400 hover:text-brand-ornage">
                                Contact
                            </Link>
                        </li>
                ...
                <div>
                    ...
                    <div className="flex space-x-4 mt-2">
                        ...
                        <a
                         href="https://www.instagram.com/coulsource"
                         target="_blank"
                         rel="noopener noreferrer"
                         className="text-gray-400 hover:text-brand-orange"
                        >
